...
rray__add <- function(x, y, new_dim_names) {
    .Call(`_rray_rray__add`, x, y, new_dim_names)
}

rray__subtract <- function(x, y, new_dim_names) {
    .Call(`_rray_rray__subtract`, x, y, new_dim_names)
}

rray__divide <- function(x, y, new_dim_names) {
    .Call(`_rray_rray__divide`, x, y, new_dim_names)
}

rray__multiply <- function(x, y, new_dim_names) {
    .Call(`_rray_rray__multiply`, x, y, new_dim_names)
}

rray__pow <- function(x, y, new_dim_names) {
    .Call(`_rray_rray__pow`, x, y, new_dim_names)
}
